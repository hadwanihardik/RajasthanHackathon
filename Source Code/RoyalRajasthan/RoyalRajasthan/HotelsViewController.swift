...
class HotelsViewController: UIViewController,UITableViewDataSource,UITableViewDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        tblViewHotels.register(UINib(nibName: "HotelsTableCell", bundle: nil), forCellReuseIdentifier: "HotelsTableCell")
        
        arrayForTravels = DBHandler.selectData(fromTable: "hotels")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let identifier = "HotelsTableCell"
        let cell = tableView.dequeueReusableCell(withIdentifier: identifier) as! HotelsTableCell
        
        var data = hotelsModel()
        
        data = Utils.getHotelsWithValues(dictLead:(arrayForTravels.object(at: indexPath.row) as! NSMutableDictionary))
    ...
    func handleRegister(sender: UIButton){
        ...
        data = Utils.getHotelsWithValues(dictLead:(arrayForTravels.object(at: sender.tag) as! NSMutableDictionary))
